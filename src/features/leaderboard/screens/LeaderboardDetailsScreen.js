...
const LeaderboardDetailsScreen = ({ route, navigation }) => {
  ...
  const fetchExerciseData = async () => {
    ...
    const snapshot = await db.collection('leaderboard')
      .where("exercise", "==", exercise) // Fetch only records for this exercise
      .get();
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Leaderboard for {exercise}</Text>
      <FlatList 
        data={data}
